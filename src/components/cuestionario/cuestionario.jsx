      ...
      return (
        <div>
          ...
          <div className="bg-blue-900 w-full py-4 text-center shadow-lg">
            ...
            <p className="text-white">Responde las siguientes preguntas para ayudarnos a crear tu estrategia</p>
          </div>
          ...
          <div className="max-w-5xl mx-auto mt-8 p-6 bg-white rounded-lg shadow-md">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-6 text-left">
                <label className="block text-gray-700 font-semibold mb-2">
                  ¿Qué certificaciones o educación formal respaldan tu experiencia?
                </label>
                <textarea
                  type="text"
                  name="certifications"
              ...
              <div className="mb-6 text-left">
                <label className="block text-gray-700 font-semibold mb-2">
                  ¿Cuáles son las tecnologías o metodologías en las que te especializas?
                </label>
                <textarea
                  type="text"
                  name="technologies"
